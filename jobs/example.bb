...
git_bundle: src_dir=~/PycharmProjects/BackBacker; dest_dir=/tmp;
#hg_bundle: src_dir=/home/user/workspace/BackBacker; dest_dir=/home/user/tmp;
gzip: src_dir=~/PycharmProjects/BackBacker; dest_dir=/tmp;
...
#rsync: shell=ssh -p 22222; src_dir=/home/user/backup/; dest_dir=user@backup:~/backup/; backup_dir=/home/user/backup_deletion/; mirror;
